  ...
  return (
    ...
    <AboutContainer>
      ...
      <Heading as="h3" size="small" color={colors.primary}>License</Heading>
        <b>
          <a href="https://github.com/Hellocodex/web-check-1">Web-Check-1</a> is distributed under the MIT license,
          © <a href="https://google.com">hellocodex</a> { new Date().getFullYear()}
        </b>
        <br />
